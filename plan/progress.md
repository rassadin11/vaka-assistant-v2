...
- Приняты за 2026-07-11: **4.6** (PDF-пайплайн, b055085), **/feedback + финальные welcome//help** (2032cd6), **5.1 schedule_task** (2e294d0), **4.9 голосовые через Groq** (e0a0b89) — все с зелёным CI, живыми e2e и dev-log. №6 решён владельцем (Groq), ключ добавлен и проверен.
- **Следующий пункт — 5.2** (дневные бюджеты ₽): детализация уже написана и закоммичена (stage-5.md, 432dd5a), ТЗ для Codex готово в scratchpad прошлой сессии (пересоздать по детализации при возобновлении). Codex-запуск 5.2 был остановлен ДО каких-либо правок — рабочее дерево чистое, начинать с запуска Codex по детализации 5.2.
- После 5.2: 5.3 (счётчики лимитов — числа из pricing-draft), 5.4 (уведомления 80%). Этап 4: остались 4.7 (Google — пропускать по указанию владельца) и веха беты (за владельцем). Ревизия плана после этапа 4 ещё не проводилась (4.7 открыт).
