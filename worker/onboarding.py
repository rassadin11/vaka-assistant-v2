...
ASSISTANT_CAPABILITIES_TEXT = (
    ...
    "— все расходы записываются, потом их можно проанализировать в приложении бота\n"
    "⏰ **Напоминания** — «напомни завтра в 9 утра о рабочей встрече», пришлю тебе "
    "уведомление в чат\n"
    "🌐 **Поиск в интернете** — «посмотри, какая сейчас стоимость поездки в Москву?». "
    "Такие ответы занимают чуть больше времени, чем обычные — я реально хожу по сайтам "
    "и анализирую актуальную информацию\n"
